...
<button on:click={restart} title="újrakezdés" class="transition-all opacity-60 hover:opacity-100 active:rotate-90">
	<svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-base-content" viewBox="0 0 512 512"
