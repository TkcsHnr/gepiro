...
<a on:click={startNew} href="/" class="opacity-60 hover:opacity-100 transition-opacity flex gap-2 text-lg items-center">
	Teszt
	<svg xmlns="http://www.w3.org/2000/svg" class="h-6 fill-current" viewBox="0 0 576 512"
