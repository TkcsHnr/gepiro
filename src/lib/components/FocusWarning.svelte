<script>
	import { inputFocused } from '$lib/stores/stores';
</script>

<p class="focus-warning transition-opacity duration-100 sm:text-lg" class:opacity-0={$inputFocused}>
	<svg xmlns="http://www.w3.org/2000/svg" class="h-3 sm:h-4 fill-current" viewBox="0 0 320 512"
